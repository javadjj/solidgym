                                ...
                                <ul class="lang_list">
                                    @foreach ($languages as $language)
                                        <li><a id="{{ $code == $language->code ? 'selected-language' : '' }}"
                                                href="{{ route('admin.home-3', ['code' => $language->code]) }}"><i
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-pills flex-column" id="generalTab" role="tablist">
                                    @include('admin.pages.manage-home-page.tabs.navbar-3')
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content" id="myTabContent2">
                                    @include('admin.pages.manage-home-page.sections.about-home-3')
                                    @include('admin.pages.manage-home-page.sections.video-3')
                                </div>
                            </div>
                        </div>
                    </div>
...
@if ($code == $languages->first()->code)
    @push('js')
        <script>
            ...
            //input image preview
            $(document).ready(function() {
                prevImage('about_us_image-upload', 'about_us_image-preview', 'about_us_image-label')
                prevImage('video_bg_image-upload', 'video_bg_image-preview', 'video_bg_image-label')
            });
        </script>
    @endpush
@else

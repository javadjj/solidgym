        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Edit Activity') }}</div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if ($code !== $languages->first()->code && checkAdminHasPermission('activity.translate'))
                                <hr>
                                ...
                                <ul class="lang_list">
                                    @foreach ($languages as $language)
                                        <li><a id="{{ $code == $language->code ? 'selected-language' : '' }}"
                                                href="{{ route('admin.activity.edit', ['activity' => $activity->id, 'code' => $language->code]) }}"><i
                                        ...
                                        <div class="col-md-8 offset-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name"
                                                    required
                                                    value="{{ old('name', $activity?->getTranslation($code)?->name) }}"
                                                    data-translate="true">
                                                @error('name')

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if ($code !== $languages->first()->code && checkAdminHasPermission('product.category.translate'))
                                <hr>
                                            ...
                                            <div class="col-md-8 offset-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="slug" name="slug"
                                                        value="{{ old('slug', $cat->slug) }}" class="form-control">
                                                    @error('slug')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-8 offset-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="description" name="description"
                                                    value="{{ old('description', $cat->getTranslation($code)->description) }}"

        ...
        <section class="wsus__pricing mt_110 xs_mt_90 mb_120 xs_mb_100">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <style>
                        .wsus__single_pricing_6_mnths ul li {
                            color: #000000;
                        }
                    </style>
                    <div class="col-lg-4">
                        <div class="wow fadeInUp">
                            <div class="wsus__single_pricing wsus__single_pricing_6_mnths" style="background-color:#f68f1e;margin-top:66px;">
                                <h3>6 Months Personal Training</h3>
                                <ul class="text-black">
                                    ...
                                    <li>Treadmill Access</li>
                                    <li>3 Free Steam Bath</li>
                                    <li>Weight Loss &amp; Gain Sessions</li>
                                </ul>
                                ...
                                <div class="bottom">
                                    ...
                                    <a href="javascript:;" class="common_btn white_btn common_btn_2 join-now" data-plan="monthly"
                                        data-plan_id="6"> Join Now <i class="far fa-long-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>

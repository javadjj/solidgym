                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div id="image-preview" class="image-preview"
                                                @if ($team->image ?? false) style="background-image: url({{ asset($team->image) }}); background-size: cover; background-position: center center;" @endif>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select name="status" class="form-select">
                                                <option {{ $team->status == 'active' ? 'selected' : '' }} value="active">
                                                    {{ __('Active') }}</option>
                                                <option {{ $team->status == 'inactive' ? 'selected' : '' }}

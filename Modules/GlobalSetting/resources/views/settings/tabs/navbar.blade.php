...
<li class="nav-item">
    <a class="nav-link" id="site-color-tab" data-bs-toggle="tab" href="#site_color_tab" role="tab"
        aria-controls="site-color" aria-selected="false">{{ __('Site Color') }}</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a class="nav-link" id="website-tab" data-bs-toggle="tab" href="#website_tab" role="tab" aria-controls="website"
        aria-selected="true">{{ __('Website Setting') }}</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a class="nav-link" id="maintenance-tab" data-bs-toggle="tab" href="#mmaintenance_mode_tab" role="tab"

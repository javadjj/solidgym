...
{
    public function __construct(private PageUtilityService $pageUtility) {}
    /**
     * Display the password reset view.
     */
    public function create(Request $request): View
    {
        $utility = $this->pageUtility->getPageUtility();
        return view('auth.reset-password', ['request' => $request, 'utility' => $utility]);
    }
    ...
    public function custom_reset_password_page(Request $request, $token)
    {
        ...
        return view('auth.reset-password', ['user' => $user, 'token' => $token, 'utility' => $utility]);
    }
